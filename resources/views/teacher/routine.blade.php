    ...
    @endphp
        ...
        <div class="col-md-12">
            @foreach ($teachers as $teacher)
                @php
                    $teacherDetails = App\Models\Teacher::where('user_id', $teacher)->first();
                @endphp
                <table border="5" cellspacing="0" align="center">
                    <caption>
                        {{ $teacherDetails->teacherToUser->userToClass->class_name . ' - User: ' . $teacherDetails->teacherToUser->user }}
                    </caption>
                    <tr class="border">
                    ...
                    <tr class="border">
                        @php
                            $satDetails = App\Models\Teacher::where('user_id', $teacher)
                    ...
                    <tr class="border">
                        @php
                            $sunDetails = App\Models\Teacher::where('user_id', $teacher)
                    ...
                    <tr class="border">
                        @php
                            $monDetails = App\Models\Teacher::where('user_id', $teacher)
                    ...
                    <tr class="border">
                        @php
                            $tusDetails = App\Models\Teacher::where('user_id', $teacher)
                    ...
                    <tr class="border">
                        @php
                            $wedDetails = App\Models\Teacher::where('user_id', $teacher)
                    ...
                    <tr class="border">
                        @php
                            $thuDetails = App\Models\Teacher::where('user_id', $teacher)
