...
<head>
    ...
    <style>
        body {
            background: url('https://img.freepik.com/premium-vector/welcome-back-school-background_3589-817.jpg?w=2000') no-repeat center center fixed;
                        ...
                        <div class="col-lg-7">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                ...
                                <div class="card-body">
                                    <form action="{{ route('register_auth') }}" method="post">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <input name="firstname" class="form-control" id="inputFirstName"
                                                        type="firstname" placeholder="Enter your first name" />
                                                    <label for="inputFirstName">First name</label>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-floating">
                                                    <input name="lasttname" class="form-control" id="inputLasttName"
                                                        type="lasttname" placeholder="Enter your last name" />
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <input name="confrimpassword" class="form-control"
                                ...
                                <div class="card-footer text-center py-3">
                                    <div class="small"><a href="{{ route('login_auth') }}">Have an account? Go to
                                            login</a></div>
                                </div>
                            </div>
                        </div>
