                            ...
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form action="{{ route('register_auth') }}" method="post">
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input name="firstname" class="form-control" id="inputFirstName" type="firstname" placeholder="Enter your first name" />
                                                        <label for="inputFirstName">First name</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-floating">
                                                    <input name="lasttname" class="form-control" id="inputLasttName" type="lasttname" placeholder="Enter your last name" />
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input name="confrimpassword" class="form-control" id="inputPasswordConfirm" type="password" placeholder="Confirm password" />
                                    ...
                                    <div class="card-footer text-center py-3">
                                        <div class="small"><a href="{{ route('login_auth') }}">Have an account? Go to login</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
